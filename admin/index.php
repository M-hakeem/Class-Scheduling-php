...
<div id="nav">
    ...
    <div id="content">
    		<div class="content-nav">
				...
				<h1>Welcome to ICICT ABU Zaria Online Scheduling</h1><br/>
		
			WELCOME TO INSTITUTE OF COMPUTING AND ICT ONLINE SCHEDULING SYSTEM <br> FROM HERE STAFF AND STUDENT CAN VIEW THEIR LECTURE SCHEDULE AND VENUE......
			   </div>
			<div class="side-wrap">
