...
<div id="wrapper">
	<div class="wrapper-logo">
	 ...
	 <div id="content">
            ...
            <h1 align="center"><font color="#337033" size="5" face="Arial">Staff Class Schedule</font></h1>
			<?php require "includes/db.php"; ?>
			  <?php
				...
				$search = mysql_query("SELECT * FROM schedule.schedule WHERE TeacherID LIKE '%$teacher%' AND YearID LIKE '%$year%' AND SemID LIKE '%$sem%' HAVING DayID = 1") 
				or die (mysql_error());
				...
				if (!$con)
				  ...
				  die('Could not connect: ' . mysql_error());
					...
					echo'
					<div class="name">
					<b>Instructor:</b> '.$teachera['TeacherName'].'
					<br />
					Monday
					</div>';	
			...
			$search = mysql_query("SELECT * FROM schedule.schedule WHERE TeacherID LIKE '%$teacher%' AND YearID LIKE '%$year%' AND SemID LIKE '%$sem%' HAVING DayID = 2") 
				or die (mysql_error());
...
<?php
			...
			$search = mysql_query("SELECT * FROM schedule.schedule WHERE TeacherID LIKE '%$teacher%' AND YearID LIKE '%$year%' AND SemID LIKE '%$sem%' HAVING DayID = 3") 
				or die (mysql_error());
...
<?php
			...
			$search = mysql_query("SELECT * FROM schedule.schedule WHERE TeacherID LIKE '%$teacher%' AND YearID LIKE '%$year%' AND SemID LIKE '%$sem%' HAVING DayID = 4") 
				or die (mysql_error());
...
<?php
			...
			$search = mysql_query("SELECT * FROM schedule.schedule WHERE TeacherID LIKE '%$teacher%' AND YearID LIKE '%$year%' AND SemID LIKE '%$sem%' HAVING DayID = 5") 
				or die (mysql_error());
