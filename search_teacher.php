...
<title>SEARCH | Teacher Schedule</title>
...
<div id="wrapper">
    ...
    <div id="content">
			...
			<div class="content-wrap2" align="center">
        			<h1><font color="#337033" size="5" face="Arial">Search Teacher Schedule</font></h1><br/><br/>
				<form action="teachernext.php" method="post">
                   <div class="content"> </div> <table>
					<tr>
						<td><label>Teacher:</label></td>
						<td><select name="teacher" style="width:300px"/>
						<?php
					...
					<tr>
						...
						<?php } while ($row = mysql_fetch_assoc($result));?></select></td>
					</tr>
